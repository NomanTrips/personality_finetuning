...
import time
from accelerate import Accelerator # for multi gpu

import wandb
wandb.init(project='sft_silverhand', name='DDP')
...
training_arguments = TrainingArguments(
    ...
    ddp_find_unused_parameters=False, # https://github.com/huggingface/transformers/issues/23018
)
